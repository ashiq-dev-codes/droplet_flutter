...
class AppColors {
  ...
  static const Color primaryColor = Color(0xFFB2E6FF);
  ...
  // Gray color shades
  static const Color paleGrayColor = Color(0xFFDCDCDC);
  static const Color gainsboroColor = Color(0xFFD8D8D8);

  // Primary Water Blue Palette
  static const Color waterBlue50 = Color(0xFFF0F9FF);
  static const Color waterBlue100 = Color(0xFFE0F2FE);
  static const Color waterBlue200 = Color(0xFFB9E5FE);
  static const Color waterBlue300 = Color(0xFF7CD4FD);
  static const Color waterBlue400 = Color(0xFF36BFFA);
  static const Color waterBlue500 = Color(0xFF0BA5EC);
  static const Color waterBlue600 = Color(0xFF0086C9);
  static const Color waterBlue700 = Color(0xFF006FA3);
  static const Color waterBlue800 = Color(0xFF015F86);
  static const Color waterBlue900 = Color(0xFF065986);

  // Light Blue / Sky Blue (for backgrounds, cards)
  static const Color skyBlue50 = Color(0xFFF0F7FF);
  static const Color skyBlue100 = Color(0xFFE0EFFF);
  static const Color skyBlue200 = Color(0xFFC6E0FF);
  static const Color skyBlue300 = Color(0xFF99CAFF);
  static const Color skyBlue400 = Color(0xFF66ADFF);
  static const Color skyBlue500 = Color(0xFF3D8EFF);

  // Soft Blue (primary button, accents)
  static const Color softBlue50 = Color(0xFFF0F7FF);
  static const Color softBlue100 = Color(0xFFD9ECFF);
  static const Color softBlue200 = Color(0xFFB3DAFF);
  static const Color softBlue300 = Color(0xFF7CBFFF);
  static const Color softBlue400 = Color(0xFF3DA0FF);
  static const Color softBlue500 = Color(0xFF1A8CFF);
  static const Color softBlue600 = Color(0xFF0070E0);

  // Light Background Colors
  static const Color backgroundLight = Color(0xFFF8FBFF);
  static const Color backgroundCard = Color(0xFFFFFFFF);
  static const Color backgroundModal = Color(0xFFF5F8FA);
  ...
  // Green (for consistency/streak indicators)
